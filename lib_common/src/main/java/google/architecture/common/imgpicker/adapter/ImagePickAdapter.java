...
import google.architecture.common.imgpicker.activity.ImageBrowserActivity;
...
import static google.architecture.common.imgpicker.activity.ImageBrowserActivity.IMAGE_BROWSER_INIT_INDEX;
import static google.architecture.common.imgpicker.activity.ImageBrowserActivity.IMAGE_BROWSER_SELECTED_LIST;
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Util.detectIntent(mContext, intent)) {
                        ...
                        ToastUtils.showShortToast(R.string.vw_no_photo_app);
                    }
                }
            });
        } else {
            ...
            holder.mCbx.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!v.isSelected() && isUpToMax()) {
                        ToastUtils.showShortToast(mContext.getResources().getString(R.string.vw_up_to_max, mMaxNumber));
                        return;
                    }
