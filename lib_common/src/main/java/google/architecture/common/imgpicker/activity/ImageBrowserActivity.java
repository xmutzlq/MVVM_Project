...
import static google.architecture.common.imgpicker.activity.ImagePickActivity.DEFAULT_MAX_NUMBER;
...
public class ImageBrowserActivity extends BaseActivity {
    ...
    protected int getLayout() {
        return R.layout.vw_activity_image_browser;
    }
        ...
        mSelectView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!v.isSelected() && isUpToMax()) {
                    ToastUtils.showShortToast(getResources().getString(R.string.vw_up_to_max, mMaxNumber));
                    return;
                }
