package google.architecture.common.base.top.options;
...
public class ToolbarOptions {
    ...
    private ToolbarOptions() {
        setTitleColor(ContextCompat.getColor(BaseApplication.getIns(), R.color.white));
        setOtherTextColor(ContextCompat.getColor(BaseApplication.getIns(), R.color.white));
    }
