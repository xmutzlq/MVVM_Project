...
public class LazyLoadBaseFragment extends BaseLifeCircleFragment {
    ...
    private boolean isOnPengdingState = false;
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        LogUtils.tag("zlq").e(getClass().getSimpleName() + "  onHiddenChanged dispatchChildVisibleState  hidden " + hidden);
...
//        // 当父 dispatchChildVisibleState 的时候第二次回调本方法 visible = false 所以此处 visible 将直接返回
        ...
        if (visible) {
            if (mIsFirstVisible && !isOnPengdingState) {
    ...
    public void setIsPengdingState(boolean isPengdingState) {
        isOnPengdingState = isPengdingState;
    }

    public void onFragmentFirstVisible() {
        LogUtils.tag("zlq").e(getClass().getSimpleName() + "  对用户第一次可见");
    }

    public void onFragmentResume() {
        LogUtils.tag("zlq").e(getClass().getSimpleName() + "  对用户可见");
        //初始化沉浸式
        if (isImmersionBarEnabled()) {
            initImmersionBar();
        }

        if(isOnPengdingState) {
            isOnPengdingState = false;
        }
    }

    public void onFragmentPause() {
        LogUtils.tag("zlq").e(getClass().getSimpleName() + "  对用户不可见");
