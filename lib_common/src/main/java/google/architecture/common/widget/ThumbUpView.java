...
public class ThumbUpView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            edgeColor = typedArray.getColor(R.styleable.ThumbUpView_ThumbUpView_edgeColor, edgeColor);
            fillColor = typedArray.getColor(R.styleable.ThumbUpView_ThumbUpView_fillColor, fillColor);
            cracksColor = typedArray.getColor(R.styleable.ThumbUpView_ThumbUpView_cracksColor, cracksColor);
            bgColor = typedArray.getColor(R.styleable.ThumbUpView_ThumbUpView_bgColor, bgColor);
            int type = typedArray.getInteger(R.styleable.ThumbUpView_ThumbUpView_unlikeType, 0);
    ...
    private void drawDrops(Canvas canvas, float mAnimatedBrokenValue) {
        ...
        canvas.drawCircle(rectFlove.centerX() -
                ...
                rectFlove.width() / 15 +
                        rectFlove.width() / 18 * (1 - mAnimatedBrokenValue), mPaintLike);
