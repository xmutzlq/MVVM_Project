package google.architecture.common.widget.rating;
...
public class CBRatingBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        starStrokeWidth = array.getDimensionPixelOffset(R.styleable.CBRatingBar_starStrokeWidth, DEFAULT_STAR_STROKE_WIDTH);
