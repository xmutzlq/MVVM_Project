...
public class MyNestedScrollView extends FrameLayout implements NestedScrollingParent,
     ...
     *
     * @see #setOnScrollChangeListener(MyNestedScrollView.OnScrollChangeListener)
     */
    ...
    private boolean mOutSizeInterrupt = false;
    ...
    private MyNestedScrollView.SavedState mSavedState;

    private static final MyNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new MyNestedScrollView.AccessibilityDelegate();
    ...
    private MyNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;
     ...
     */
    public void setOnScrollChangeListener(@Nullable MyNestedScrollView.OnScrollChangeListener l) {
    ...
    public void setOutSizeInterrupt(boolean outSizeInterrupt) {
        mOutSizeInterrupt = outSizeInterrupt;
    }
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                */
                ...
                if(mOutSizeInterrupt) { //拦截Scroller
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof MyNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        MyNestedScrollView.SavedState ss = (MyNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        MyNestedScrollView.SavedState ss = new MyNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<MyNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<MyNestedScrollView.SavedState>() {
                    @Override
                    public MyNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new MyNestedScrollView.SavedState(in);
                    }

                    @Override
                    public MyNestedScrollView.SavedState[] newArray(int size) {
                        return new MyNestedScrollView.SavedState[size];
                    }
                };
    }
