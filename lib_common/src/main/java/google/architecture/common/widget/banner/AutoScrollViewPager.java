...
import google.architecture.common.widget.banner.recycle.AdvertImagePagerAdapterDecorator;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    public void scrollOnce() {
        ...
        } else if (isNotScrollRecycle() && nextItem == totalCount) {
            if (isCycle) {
	...
	public void setAdapter(PagerAdapter advertPagerAdapter) {
		...
		if(advertPagerAdapter instanceof AdvertImagePagerAdapter) {
			super.setAdapter(new AdvertImagePagerAdapterDecorator((AdvertImagePagerAdapter) advertPagerAdapter));
		} else {
			super.setAdapter(this.advertPagerAdapter);
		}
	}
