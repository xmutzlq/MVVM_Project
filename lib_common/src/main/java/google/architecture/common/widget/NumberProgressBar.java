...
public class NumberProgressBar extends View {
	...
	private final float default_round_x = 0.0f;
	private final float default_round_y = 0.0f;
	/**
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mDrawReachedBar) {
			canvas.drawRoundRect(mReachedRectF, default_round_x, default_round_y, mReachedBarPaint);
		}

		if (mDrawUnreachedBar) {
			canvas.drawRoundRect(mUnreachedRectF, default_round_x, default_round_y, mUnreachedBarPaint);
		}
